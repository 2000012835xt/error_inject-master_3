...
from cifar100_task import Cifar100Task
...
def module_inject_error(model, module_names, prob, bw=32, bw_hardware=24):
    ...
    for name in module_names:
        ...
        module.register_forward_hook(inject_error_hook(name, prob))
...
def my_hook(module, input, output):
        ...
        print(input[0].q_scale())
        print(module.weight().q_scale())
        print(output.q_scale())
...
if __name__ == "__main__":
    ...
    # task = Cifar100Task(data_root='/home/zzd/zzd_data/PycharmProjects/data')
    ...
    model = models.vgg16_bn(num_classes=100)
    ...
    ptq_model = ptq_model.to(device).eval()
    ...
    #         hook = module.register_forward_hook(save_linear_data)

    # test_one_time(ptq_model, criterion, test_loader, device, epoch=0)
    ...
    for i in range(len(error_rate_all_layer[0])):
        ...
        for repeat_i in range(2):
            ...
            # pdb.set_trace() # module inject error速度挺快的
